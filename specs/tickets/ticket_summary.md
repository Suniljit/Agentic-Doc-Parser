...
| 04 | [FastMCP Datetime Server](04-fastmcp-datetime-server.md) | AFK | #01 | `done` |
| 05 | [Part 2: Tool-Calling & Date Reasoning](05-part2-tool-calling-date-reasoning.md) | AFK | #02, #04 | `done` |
| 06 | [ChromaDB RAG Store](06-chromadb-rag-store.md) | AFK | #02 | `done` |
